...
if __name__ == '__main__':
    ...
    density_guess = [0.3]     # core composition
    X_guess = [0.1,1.55]      # env mass fraction mean and std
    M_guess = [8.0,2.13]      # core mass mean and std
    ...
    if rank == 0:
        ...
        file.write("Parameters estimated: [composition, X_params, M_params]\n")
