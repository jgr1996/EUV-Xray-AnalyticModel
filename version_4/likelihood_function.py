...
def likelihood(theta, N, data_array, completeness_array):
    ...
    initial_X_coeffs = [theta[4+i] for i in range(6)]
    X_min, X_max = -3.0, 0.0
    ...
    core_mass_coeffs = [theta[10+i] for i in range(6)]
...
# thetas = [[4.0, 1.9, 0.01, 7.6, 0.01, 0.20, 0.4, 0.6, 0.8, 1.0, 0.01, 0.20, 0.4, 0.6, 0.8, 1.0]]
